...
def main():
    ...
    log_test = p2_logging.ProjLogging("DEBUG")
    ...
    log_test.change_logging_level("DEBUG")
    print("")
    ...
    log_test.log_entry("DEBUG",    "T5 - Debug Message")
    ...
    log_test.log_entry("DEBUG",    "T6 - Debug Message")
    ...
    log_test.log_entry("DEBUG",    "T7 - Debug Message")
    ...
    log_test.log_entry("DEBUG",    "T8 - Debug Message")
    ...
    print("\tTest 9 - log_entry at DEBUG level")
    log_test.change_logging_level("DEBUG")
    log_test.log_entry("DEBUG",    "T9 - Debug Message")
